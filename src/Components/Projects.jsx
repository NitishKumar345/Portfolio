      ...
      <div className="projectsBox ">
                <div className="box1">
                    ...
                    <img src={portfolioimg} alt=""  className="portfolioimg"/>
                        <h4 className='portfolioh4'>Portfolio</h4>
                          <a href="https://nitish-portfolio1.netlify.app/" target='_blank' className='livelink'>Live</a>
                    </div>
                </div>
                <div className="box1">
                    ...
                    <img src={WordtoPDF} alt="" className="Bookimg"/>
                        ...
                        <a href="https://converter-app.netlify.app/" target='_blank' className='livelink'>Live</a>
                    </div>
                </div>
                <div className="box1">
                    ...
                    <img src={fruitslicerimg} alt="" className="Fruitsimg"/>
                        ...
                        <a href="https://fruit-slicer-game.netlify.app/" target='_blank' className='livelink'>Live</a>
                    </div>
                ...
                <div className="box1">
                    ...
                    <img src={weather} alt="" className="weatherimg"/>
                        ...
                        <a href="https://weather-widget1.netlify.app/" target='_blank' className='livelink'>Live</a>
                    </div>
                </div>
            </div>
